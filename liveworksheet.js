...
﻿
alert("วิธีใช้ กดตกลงที่ข้อความ พอคำตอบขึ้นทำการกดส่งเเล้วกดเช็คคะเเนน ตึงๆ บอกเลย");
alert("ตึงจัดบอกเลย✌️✌️ but script .js by👽👽 BM so cool😎😎  ");
alert("บอกเลยคนนี้ตึงจริง👽👽 https://www.facebook.com/phiti.sarnsirirat");
alert("บอกเลยคนนี้ตึงจริง👽👽 https://www.facebook.com/phiti.sarnsirirat");
